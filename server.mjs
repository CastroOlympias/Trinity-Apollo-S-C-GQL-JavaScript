...
import { typeDefs, resolvers } from './connections/index.js'
// const db = require('./configuration/Database.js')
import { MongooseConnection } from './configuration/Database.js'

const path = require('path')
// import { path } from 'path'
const { authMiddleware } = require('./configuration/Authentication.js')
// import { authMiddleware } from './configuration/Authentication.js'
const imageRoutes = require('./routes/image-upload.js')
// import {imageRoutes} from './routes/image-upload.js'
...
async function startApolloServer() {
        ...
        app.get('*', (req, res) => {
                ...
                res.sendFile(path.join(__dirname, './client/module.mjs'));
        })
